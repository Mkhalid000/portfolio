...
// images
import Intervyou1 from "@/public/image/projects/web/intervyou/intervyou-1.jpg";
				...
				<div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
					...
					<motion.div
						...
						<p className="text-gray-600 text-justify title text-lg">
							Convoze  is a modern AI-powered call center web application developed using
							Next.js, Tailwind CSS, and JavaScript. It’s designed to enhance customer
							support operations through intelligent automation and analytics.
							The platform leverages AI features to assist agents in handling calls
							efficiently, providing real-time suggestions, and improving overall
							communication performance. With a clean UI built using Shadcn UI .
							Convoze ensures
							scalability, reliability, and a seamless user experience.
						</p>{" "}
						<div className="mt-3">
							<Button variation="primary">
								<Link href="projects/convoze">More</Link>
							</Button>
