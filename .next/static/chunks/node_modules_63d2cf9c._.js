(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_63d2cf9c._.js", {

"[project]/node_modules/@fullpage/react-fullpage/dist/react-fullpage.js [app-client] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ /******/ (()=>{
    /******/ var __webpack_modules__ = {
        ...
        /***/ 88: (__unused_webpack_module, __webpack_exports__, __webpack_require__)=>{
            ...
            class ReactFullpage extends external_react_default().Component {
                ...
                update(lastEvent) {
                    ...
                    let state = _objectSpread(_objectSpread({}, this.state), {}, {
                        sectionCount: this.getSectionCount(),
                        slideCount: this.getSlideCount()
                    });
                    const makeState = (callbackParameters)=>_objectSpread(_objectSpread(_objectSpread({}, state), callbackParameters), {}, {
                            lastEvent
                        });
        ...
        /***/ 882: (__unused_webpack_module, __webpack_exports__, __webpack_require__)=>{
            ...
            class ReactFullpageShell extends react__WEBPACK_IMPORTED_MODULE_0___default().Component {
                constructor(props){
                    super(props);
                    this.state = {};
                    this.log = (0, _Logger__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */ .Z)(this.props.debug, 'ReactFullpageShell');
                    this.log('Building component');
                }
                render() {
        ...
        /***/ },
        /***/ 563: (module1, __webpack_exports__, __webpack_require__)=>{
            "use strict";
            /* harmony export */ __webpack_require__.d(__webpack_exports__, {
                /* harmony export */ "Z": ()=>__WEBPACK_DEFAULT_EXPORT__
            });
...
*/ !function(n, t) {
                ("TURBOPACK compile-time truthy", 1) ? module1.exports = t() : ("TURBOPACK unreachable", undefined);
            }(this, function() {
                "use strict";
                ...
                var o, a = window, u = document, l = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/) || navigator.userAgent.includes("Mac") && "ontouchend" in document, c = /(Mac|iPhone|iPod|iPad)/i.test(a.navigator.userAgent), s = "ontouchstart" in a || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, f = !!window.MSInputMethodContext && !!document.documentMode, d = {
                    test: {},
                    shared: {}
                }, v = (o = window.self !== window.top, function() {
                    return o;
                });
                a.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function(n, t) {
                    t = t || window;
                ...
                var p = "fullpage-wrapper", h = "." + p, g = "fp-scrollable", m = "fp-responsive", w = "fp-notransition", b = "fp-destroyed", S = "fp-enabled", y = "active", M = ".active", T = "fp-completely", A = "fp-section", x = "." + A, O = ".fp-tableCell", k = "#fp-nav", E = "fp-slide", R = "." + E, j = ".fp-slide.active", D = "fp-slides", L = ".fp-slides", z = "fp-slidesContainer", N = "." + z, I = "fp-table", P = "fp-overflow", H = "." + P, C = "fp-is-overflow", W = ".fp-slidesNav", F = ".fp-slidesNav a", V = "fp-controlArrow", B = "." + V, Z = "fp-prev", Y = ".fp-controlArrow.fp-prev", G = ".fp-controlArrow.fp-next", X = {
                    menu: !1,
                    anchors: [],
                    lockAnchors: !1,
                    navigation: !1,
                ...
                function nn(n, t, e) {
                    J[n] = t, "internal" !== e && (Q[n] = t);
                }
                function tn() {
                    if (!$().anchors.length) {
                        var n = Oe($().sectionSelector.split(",").join("[data-anchor],") + "[data-anchor]", U);
                        n.length && n.length === Oe($().sectionSelector, U).length && (_ = !0, n.forEach(function(n) {
                ...
                function un(n) {
                    var t = $();
                    return null !== t[n] && "[object Array]" === Object.prototype.toString.call(t[n]) ? t[n].length && d[n] : t[n] && d[n];
                }
                function ln(n, t, e) {
                    if (un(n)) return oi(d[n][t]) ? d[n][t](e) : d[n][t];
                }
                function cn() {
                ...
                function vn(n) {
                    ...
                    function e(n) {
                        ...
                        for(n = n.replace(/[^A-Za-z0-9+/=]/g, ""); c < n.length;)e = t.indexOf(n.charAt(c++)) << 2 | (o = t.indexOf(n.charAt(c++))) >> 4, i = (15 & o) << 4 | (a = t.indexOf(n.charAt(c++))) >> 2, r = (3 & a) << 6 | (u = t.indexOf(n.charAt(c++))), l += String.fromCharCode(e), 64 != a && (l += String.fromCharCode(i)), 64 != u && (l += String.fromCharCode(r));
                        return l = function(n) {
                            for(var t, e = "", i = 0, r = 0, o = 0; i < n.length;)(r = n.charCodeAt(i)) < 128 ? (e += String.fromCharCode(r), i++) : r > 191 && r < 224 ? (o = n.charCodeAt(i + 1), e += String.fromCharCode((31 & r) << 6 | 63 & o), i += 2) : (o = n.charCodeAt(i + 1), t = n.charCodeAt(i + 2), e += String.fromCharCode((15 & r) << 12 | (63 & o) << 6 | 63 & t), i += 3);
                            return e;
                        }(l), l;
                    }
                    function i(n) {
                ...
                a.state = en, a.fp_utils = a.fp_utils || {}, Object.assign(a.fp_utils, {
                    prependTo: dn,
                    toggleClass: function(n, t, e) {
                        if (n.classList && null == e) n.classList.toggle(t);
                        else {
                            var i = Ee(n, t);
                            i && null == e || !e ? Ve(n, t) : (!i && null == e || e) && Fe(n, t);
                        }
                    }
                });
                var pn = function(n) {
                    ...
                    this.parent = this.parent || null, this.selector = t, this.anchor = ni(n, "data-anchor") || $().anchors[Ie(n, $().sectionSelector)], this.item = n, this.isVisible = Ae(n), this.isActive = Ee(n, y), this.q = Ee(n, P) || null != Oe(H, n)[0], this.nn = t === $().sectionSelector, this.container = Ue(n, N) || Ue(n, h), this.index = function() {
                ...
                hn.prototype.siblings = function() {
                    return this.nn ? this.isVisible ? en.R : en.tn : this.parent ? this.parent.slides : 0;
                    ...
                    return this.nn ? en.R : en.rn;
                };
                var wn, bn = function(n) {
                    pn.call(this, n);
                }, Sn = function(n) {
                    pn.call(this, n);
                };
                ...
                function Tn(n) {
                    var t, e, i = $();
                    return i.autoScrolling && !i.scrollBar ? (t = -n, e = Oe(h)[0]) : (t = n, e = window), {
                        options: t,
                        element: e
                    };
                }
                function An(n, t) {
                    !$().autoScrolling || $().scrollBar || n.self != window && Ee(n, D) ? n.self != window && Ee(n, D) ? n.scrollLeft = t : n.scrollTo(0, t) : n.style.top = t + "px";
                }
                function xn(n) {
                ...
                function Rn(n, t) {
                    t ? xn(K()) : kn(K()), clearTimeout(wn), De(K(), En(n)), d.test.on = n, wn = setTimeout(function() {
                        Ve(K(), w);
                    }, 10);
                }
                function jn(n) {
                    var t = Math.round(n);
                    if ($().css3 && $().autoScrolling && !$().scrollBar) Rn("translate3d(0px, -" + t + "px, 0px)", !1);
                    else if ($().autoScrolling && !$().scrollBar) De(K(), {
                        top: -t + "px"
                    }), d.test.top = -t + "px";
                    else {
                        var e = Tn(t);
                ...
                d.setScrollingSpeed = Dn;
                var Ln, zn = null, Nn = null, In = null;
                function Pn(n, t, e, i) {
                    var r, o = function(n) {
                        return n.self != a && Ee(n, D) ? n.scrollLeft : !$().autoScrolling || $().scrollBar ? Ke() : n.offsetTop;
                    }(n), u = t - o, l = !1, c = en.F;
                    rn({
                        F: !0
                    }), Ln && window.cancelAnimationFrame(Ln), Ln = function(s) {
                        r || (r = s);
                        var f = Math.floor(s - r);
                        if (en.F) {
                            var d = t;
                            e && (d = a.fp_easings[$().easing](f, o, u, e)), f <= e && An(n, d), f < e ? window.requestAnimationFrame(Ln) : void 0 === i || l || (i(), rn({
                                F: !1
                            }), l = !0);
                        } else l || c || (i(), rn({
                            F: !1
                        }), l = !0);
                    }, window.requestAnimationFrame(Ln);
                }
                function Hn(n) {
                ...
                function Cn(n) {
                    ...
                    Oe("video, audio", t).forEach(function(n) {
                        Hn(n) && "function" == typeof n.play && (n.readyState >= n.HAVE_FUTURE_DATA ? n.play() : n.addEventListener("canplay", function t() {
                            n.play(), n.removeEventListener("canplay", t);
                        }));
                    }), Oe('iframe[src*="youtube.com/embed/"]', t).forEach(function(n) {
                        Hn(n) && Wn(n), n.onload = function() {
                            Hn(n) && Wn(n);
                        };
                    });
                }
                ...
                function Fn(n) {
                    ...
                    Oe("video, audio", t).forEach(function(n) {
                        ...
                        /youtube\.com\/embed\//.test(ni(n, "src")) && !n.hasAttribute("data-keepplaying") && n.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*");
                    });
                }
                function Vn(n) {
                    $().lazyLoading && Oe("img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]", yn(n)).forEach(function(n) {
                        if ([
                            "src",
                            "srcset"
                        ].forEach(function(t) {
                            var e = ni(n, "data-" + t);
                            null != e && e && (wi(n, t), n.addEventListener("load", function() {}));
                        }), ui(n, "source")) {
                ...
                function Bn(n) {
                    ...
                    Vn(n.item), t && (Zn(n, "prev", t), Zn(n, "next", t));
                }
                function Zn(n, t, e) {
                    for(var i = n, r = 0; r < e && (i = i[t]()); r++)Vn(i.item);
                }
                function Yn() {
                    var n = on().j.item, t = on().j.activeSlide, e = Gn(n), i = String(e);
                    t && (i = i + "-" + Gn(t.item)), i = i.replace("/", "-").replace("#", "").replace(/\s/g, "");
                    var r = new RegExp("\\b\\s?fp-viewing-[^\\s]+\\b", "g");
                    zn.className = zn.className.replace(r, ""), Fe(zn, "fp-viewing-" + i);
                }
                function Gn(n) {
                    if (!n) return null;
                    var t = ni(n, "data-anchor"), e = Ie(n);
                    return null == t && (t = e), t;
                }
                function Xn(n, t, e) {
                    var i = "";
                    $().anchors.length && !$().lockAnchors && (n ? (null != e && (i = e), null == t && (t = n), rn({
                        W: t
                    }), Un(i + "/" + t)) : null != n ? (rn({
                        W: t
                    }), Un(e)) : Un(e)), Yn();
                ...
                function Un(n) {
                    if ($().recordHistory) location.hash = n;
                    else if (l || s) a.history.replaceState(void 0, void 0, "#" + n);
                    else {
                ...
                var Qn = {
                    ...
                    un: function(n, t) {
                        var e = this;
                        return "object" !== _n(this.an[n]) && (this.an[n] = []), this.an[n].push(t), function() {
                            return e.removeListener(n, t);
                        };
                    },
                    removeListener: function(n, t) {
                        if ("object" === _n(this.an[n])) {
                    ...
                    ln: function(n) {
                        ...
                        "object" === _n(this.an[n]) && this.an[n].forEach(function(n) {
                            return n.apply(t, i);
                        });
                    },
                    once: function(n, t) {
                ...
                function Jn(n, t, e) {
                    var i = "Section" === t ? $().anchors[n] : ni(e, "data-anchor");
                    return encodeURI($().navigationTooltips[n] || i || t + " " + (n + 1));
                }
                var Kn = "onAfterRenderNoAnchor", $n = "onClickOrTouch", qn = "moveSlideLeft", nt = "moveSlideRight", tt = "onInitialise", et = "beforeInit", it = "bindEvents", rt = "onDestroy", ot = "contentChanged", at = "onScrollOverflowScrolled", ut = "onScrollPageAndSlide", lt = "onKeyDown", ct = "onMenuClick", st = "scrollPage", ft = "landscapeScroll", dt = "scrollBeyondFullpage", vt = "onPerformMovement", pt = "onSlideLeave", ht = "onLeave", gt = "afterSectionLoads", mt = "afterSlideLoads";
                function wt(n) {
                    n.cancelable && qe(n), rn({
                        D: "horizontalNav"
                    });
                    var t = Ue(this, x), e = Oe(L, Ue(this, x))[0], i = mn(on().R, t).slides[Ie(Ue(this, "li"))];
                    Qn.ln(ft, {
                        slides: e,
                        destination: i.item
                    });
                ...
                function bt(n, t) {
                    $().slidesNavigation && null != n && (Ve(Oe(M, n), y), Fe(Oe("a", Oe("li", n)[t]), y));
                }
                var St, yt = {};
                function Mt(n, t, e) {
                    "all" !== t ? yt[e][t] = n : Object.keys(yt[e]).forEach(function(t) {
                        yt[e][t] = n;
                    });
                }
                function Tt() {
                ...
                function At() {
                    var n = Ue(this, x);
                    Ee(this, Z) || Ue(this, Z) ? Tt().m.left && (rn({
                        D: "slideArrow"
                    }), Qn.ln(qn, {
                        section: n
                    })) : Tt().m.right && (rn({
                ...
                function xt(n) {
                    !$().loopHorizontal && $().controlArrows && (li(Oe(Y, n.section), 0 !== n.slideIndex), li(Oe(G, n.section), null != ze(n.destiny)));
                }
                function Ot() {
                    clearTimeout(St), rn({
                        I: !1
                ...
                function kt(n, t, e) {
                    var i = Ue(n, x), r = on().R.filter(function(n) {
                        return n.item == i;
                        ...
                        localIsResizing: en.P
                    };
                    a.xMovement = Rt(a.prevSlideIndex, a.slideIndex), a.direction = a.direction ? a.direction : a.xMovement, a.localIsResizing || rn({
                        canScroll: !1
                    }), ln("parallax", "applyHorizontal", a), ln("cards", "apply", a), ln("dropEffect", "apply", a), ln("waterEffect", "apply", a), $().onSlideLeave && !a.localIsResizing && "none" !== a.xMovement && oi($().onSlideLeave) && !1 === Zt("onSlideLeave", a) ? rn({
                        I: !1
                    }) : (un("dropEffect") && $().dropEffect || (Fe(t, y), Ve($e(t), y)), It(), a.localIsResizing || (Fn(a.prevSlide), Bn(o)), xt(a), r.isActive && !a.localIsResizing && Xn(a.slideIndex, a.slideAnchor, a.anchorLink), ln("continuousHorizontal", "apply", a), Qn.ln(pt, a), sn() ? Dt(a) : Et(n, a, !0), $().interlockedSlides && d.interlockedSlides && (un("continuousHorizontal") && void 0 !== e && e !== a.xMovement || ln("interlockedSlides", "apply", a)));
                }
                function Et(n, t, e) {
                    var i = t.destinyPos;
                    if (bt(t.slidesNav, t.slideIndex), rn({
                        scrollX: Math.round(i.left)
                    }), $().css3) {
                        var r = "translate3d(-" + Math.round(i.left) + "px, 0px, 0px)";
                        d.test.cn[t.sectionIndex] = r, un("dragAndMove") && void 0 !== t.sn || xn(Oe(N, n)), De(Oe(N, n), En(r)), un("interlockedSlides") || clearTimeout(St), St = setTimeout(function() {
                            e && Dt(t);
                        }, $().scrollingSpeed);
                    } else d.test.left[t.sectionIndex] = Math.round(i.left), Pn(n, Math.round(i.left), $().scrollingSpeed, function() {
                        e && Dt(t);
                    });
                }
                function Rt(n, t) {
                ...
                function Dt(n) {
                    ln("continuousHorizontal", "afterSlideLoads", n), ln("dragAndMove", "afterSlideLoads", n), n.localIsResizing || (ln("parallax", "afterSlideLoads"), ln("scrollOverflowReset", "setPrevious", n.prevSlide), ln("scrollOverflowReset", "reset"), oi($().afterSlideLoad) && Zt("afterSlideLoad", n), rn({
                        canScroll: !0
                    }), Cn(n.destiny), Qn.ln(mt, n)), rn({
                        I: !1
                    }), ln("interlockedSlides", "interlockedSlides", n);
                }
                function Lt(n, t) {
                    Dn(0, "internal"), void 0 !== t && rn({
                        P: !0
                    }), kt(Ue(n, L), n), void 0 !== t && rn({
                        P: !1
                    }), Dn(q().scrollingSpeed, "internal");
                }
                yt.m = {
                    up: !0,
                    down: !0,
                    left: !0,
                    right: !0
                }, yt.k = ke({}, yt.m), Qn.un($n, function(n) {
                    var t = n.target;
                    (ui(t, B) || Ue(t, B)) && At.call(t, n);
                }), d.landscapeScroll = kt, Qn.un(it, function() {
                    Qn.un(vt, Ot);
                });
                var zt = null, Nt = null;
                function It() {
                    en.j = null, en.R.map(function(n) {
                        var t = Ee(n.item, y);
                        n.isActive = t, n.q = Me.q(n.item), t && (en.j = n), n.slides.length && (n.activeSlide = null, n.slides.map(function(t) {
                            var e = Ee(t.item, y);
                            t.q = Me.q(n.item), t.isActive = e, e && (n.activeSlide = t);
                        }));
                    }), function() {
                        var n = en.j, t = !!en.j && en.j.slides.length, e = en.j ? en.j.activeSlide : null;
                        if (!n && en.R.length && !on().L) {
                            if (zt) {
                                var i = Ct(zt, en.R);
                                i && (en.j = i, en.j.isActive = !0, Fe(en.j.item, y)), en.j && jn(en.j.item.offsetTop);
                            }
                            if (t && !e && Nt) {
                                var r = Ct(Nt, en.j.slides);
                                r && (en.j.activeSlide = r, en.j.activeSlide.isActive = !0, Fe(en.j.activeSlide.item, y)), en.j.activeSlide && Lt(en.j.activeSlide.item, "internal");
                            }
                        }
                    }(), ai(K(), "onUpdateStateDone");
                }
                function Pt() {
                    var n = Oe($().sectionSelector + ", " + x, K()), t = xe(n), e = Array.from(n).map(function(n) {
                        return new Wt(n);
                    ...
                    zt = Ht(en.j), Nt = Ht(en.j ? en.j.activeSlide : null), en.A = t.length, en.O = i.reduce(function(n, t) {
                        return n + t.slides.length;
                    }, 0), en.R = i, en.tn = e, en.slides = r, en.rn = en.R.concat(en.slides);
                }
                function Ht(n) {
                    if (!n) return null;
                    var t = n ? n.item : null, e = n.nn ? en.tn : en.j.dn;
                    if (t) {
                        var i = mn(e, t);
                ...
                var Wt = function(n) {
                    var t = this;
                    [].push.call(arguments, $().sectionSelector), hn.apply(this, arguments), this.vn = Oe($().slideSelector, n), this.dn = Array.from(this.vn).map(function(n) {
                        return new Ft(n, t);
                ...
                Wt.prototype = hn.prototype, Wt.prototype.constructor = Wt;
                var Ft = function(n, t) {
                    this.parent = t, hn.call(this, n, $().slideSelector);
                };
                function Vt(n) {
                    return n && !n.item ? new bn(new Wt(n)) : n ? new bn(n) : null;
                }
                function Bt(n) {
                    return n ? new Sn(n) : null;
                }
                function Zt(n, t) {
                    var e = function(n, t) {
                        var e = {
                            afterRender: function() {
                                return {
                                    section: Vt(on().j),
                                    pn: Bt(on().j.activeSlide)
                                };
                            },
                            onLeave: function() {
                                return {
                                    origin: Vt(t.items.origin),
                                    destination: Vt(t.items.destination),
                    ...
                    return ai(K(), n, e), !1 !== $()[n].apply(e[Object.keys(e)[0]], hi(e));
                }
                function Yt(n, t) {
                ...
                function Gt(n, t) {
                    ...
                    var e = on().j.item;
                    if ($().autoScrolling && !$().scrollBar) De(In, {
                        overflow: "hidden",
                        height: "100%"
                    }), Ve(zn, g), Yt(q().recordHistory, "internal"), De(K(), {
                        "-ms-touch-action": "none",
                        "touch-action": "none"
                    }), null != e && jn(e.offsetTop);
                    else if (De(In, {
                        overflow: "visible",
                        height: "initial"
                    }), Fe(zn, g), Yt(!!$().autoScrolling && q().recordHistory, "internal"), De(K(), {
                        "-ms-touch-action": "",
                        "touch-action": ""
                    }), kn(K()), null != e) {
                ...
                function Xt() {
                    for(var n = Oe(j), t = 0; t < n.length; t++)Lt(n[t], "internal");
                }
                function Ut() {
                    var n = Oe(".fp-auto-height")[0] || ve() && Oe(".fp-auto-height-responsive")[0];
                    $().lazyLoading && n && Oe(".fp-section:not(.active)").forEach(function(n) {
                        var t, e, i, r, o;
                        e = (t = n.getBoundingClientRect()).top, i = t.bottom, r = e + 2 < en.U && e > 0, o = i > 2 && i < en.U, (r || o) && Bn(mn(on().R, n));
                    });
                }
                function _t() {
                    ai(Le(this), "click");
                ...
                function Qt() {
                    ...
                    n.appendChild(t), Be(n, zn);
                    var e = Oe(k)[0];
                    Fe(e, "fp-" + $().navigationPosition), $().showActiveTooltip && Fe(e, "fp-show-active");
                    for(var i = "", r = 0; r < on().R.length; r++){
                        var o = on().R[r], a = "";
                        $().anchors.length && (a = o.anchor), i += '<li><a href="#' + encodeURI(a) + '"><span class="fp-sr-only">' + Jn(o.index(), "Section") + "</span><span></span></a>";
                        var l = $().navigationTooltips[o.index()];
                        void 0 !== l && "" !== l && (i += '<div class="fp-tooltip fp-' + $().navigationPosition + '">' + l + "</div>"), i += "</li>";
                    }
                    Oe("ul", e)[0].innerHTML = i;
                    var c = Oe("li", Oe(k)[0])[on().j.index()];
                    Fe(Oe("a", c), y);
                }
                function Jt(n) {
                    n.preventDefault && qe(n), rn({
                        D: "verticalNav"
                    });
                ...
                function Kt(n, t) {
                    var e;
                    e = n, $().menu && $().menu.length && Oe($().menu).forEach(function(n) {
                        null != n && (Ve(Oe(M, n), y), Fe(Oe('[data-menuanchor="' + e + '"]', n), y));
                    }), function(n, t) {
                        var e = Oe(k)[0];
                        $().navigation && null != e && "none" !== e.style.display && (Ve(Oe(M, e), y), Fe(n ? Oe('a[href="#' + n + '"]', e) : Oe("a", Oe("li", e)[t]), y));
                    }(n, t);
                }
                Ft.prototype = hn.prototype, Ft.prototype.constructor = Wt, d.setRecordHistory = Yt, d.setAutoScrolling = Gt, d.test.setAutoScrolling = Gt, (new Date).getTime();
                var $t, qt, ne, te, ee, ie, re = (qt = !0, ne = (new Date).getTime(), te = !a.fullpage_api, function(n, t) {
                    var e = (new Date).getTime(), i = "wheel" === n ? $().scrollingSpeed : 100;
                    return qt = te || e - ne >= i, te = !a.fullpage_api, qt && ($t = t(), ne = e), void 0 === $t || $t;
                });
                function oe(n, t) {
                    if (oi($().beforeLeave)) return re(on().D, function() {
                        return Zt(n, t);
                    });
                }
                function ae(n, t, e) {
                    ...
                    if (null != i) {
                        ...
                        if (!(on().j.item == i && !en.P || $().scrollBar && Ke() === a.dtop && !Ee(i, "fp-auto-height"))) {
                            if (null != a.activeSlide && (r = ni(a.activeSlide, "data-anchor"), o = Ie(a.activeSlide, null)), !a.localIsResizing) {
                                var u = a.yMovement;
                                if (void 0 !== e && (u = e ? "up" : "down"), a.direction = u, an("dropEffect") && d.dropEffect.onLeave_(a), an("waterEffect") && d.waterEffect.onLeave_(a), oi($().beforeLeave) && !1 === oe("beforeLeave", a)) return;
                                if (oi($().onLeave) && !Zt("onLeave", a)) return;
                            }
                            ln("parallax", "apply", a), ln("cards", "apply", a), ln("dropEffect", "apply", a), ln("waterEffect", "apply", a), $().autoScrolling && $().continuousVertical && void 0 !== a.isMovementUp && (!a.isMovementUp && "up" == a.yMovement || a.isMovementUp && "down" == a.yMovement) && (a = function(n) {
                                rn({
                                    _: !0
                                });
                                var t = on().j.item;
                                return n.isMovementUp ? Qe(t, vi(t, x)) : _e(t, pi(t, x).reverse()), jn(on().j.item.offsetTop), Xt(), n.hn = t, n.dtop = n.element.offsetTop, n.yMovement = On(on().j, n.element), n.leavingSection = n.items.origin.index() + 1, n.sectionIndex = n.items.destination.index(), ai(K(), "onContinuousVertical", n), n;
                            }(a)), ln("scrollOverflowReset", "setPrevious", on().j.item), a.localIsResizing || Fn(on().j.item), un("dropEffect") && $().dropEffect || (Fe(i, y), Ve($e(i), y)), It(), Bn(n), rn({
                                canScroll: d.test.gn
                            }), Xn(o, r, a.anchorLink), Qn.ln(ht, a), function(n) {
                                rn({
                                    V: "none",
                                    scrollY: Math.round(n.dtop)
                                }), Qn.ln(vt, n);
                                var t = $().scrollingSpeed < 700, e = t ? 700 : $().scrollingSpeed;
                                if ($().css3 && $().autoScrolling && !$().scrollBar) Rn("translate3d(0px, -" + Math.round(n.dtop) + "px, 0px)", !0), un("waterEffect") && Xt(), $().scrollingSpeed ? (clearTimeout(ee), ee = setTimeout(function() {
                                    le(n), rn({
                                        canScroll: !t || d.test.gn
                                    });
                                }, $().scrollingSpeed)) : le(n);
                                else {
                                    var i = Tn(n.dtop);
                                    d.test.top = -n.dtop + "px", clearTimeout(ee), Pn(i.element, i.options, $().scrollingSpeed, function() {
                                        $().scrollBar ? ee = setTimeout(function() {
                                            le(n);
                                        }, 30) : (le(n), rn({
                                            canScroll: !t || d.test.gn
                                        }));
                                ...
                                C: a.anchorLink
                            }), Kt(a.anchorLink, function(n) {
                                return null != n.hn ? n.isMovementUp ? en.A - 1 : 0 : n.sectionIndex;
                            }(a));
                        }
                    }
                }
                function ue(n) {
                    var t = n.offsetHeight, e = n.offsetTop, i = e, r = un("dragAndMove") && ln("dragAndMove", "isGrabbing") ? ln("dragAndMove", "isScrollingDown") : e > en.X, o = i - Re() + t, a = $().bigSectionsDestination;
                    return t > Re() ? (r || a) && "bottom" !== a || (i = o) : (r || en.P && null == ze(n)) && (i = o), un("offsetSections") && (i = d.offsetSections.getSectionPosition_(r, i, n)), rn({
                        X: i
                    }), i;
                }
                function le(n) {
                    rn({
                        ...
                        null != n.hn && (n.isMovementUp ? Qe(Oe(x)[0], n.hn) : _e(Oe(x)[on().R.length - 1], n.hn), jn(on().j.item.offsetTop), function() {
                            for(var n = Oe(j), t = 0; t < n.length; t++)Lt(n[t], "internal");
                        }(), n.sectionIndex = n.items.destination.index(), n.leavingSection = n.items.origin.index() + 1, rn({
                            _: !1
                        }));
                    }(n), oi($().afterLoad) && !n.localIsResizing && Zt("afterLoad", n), ln("parallax", "afterLoad"), ln("waterEffect", "afterLoad"), ln("dropEffect", "afterLoad"), ln("scrollOverflowReset", "reset"), ln("resetSliders", "apply", n), It(), n.localIsResizing || Cn(n.element), Fe(n.element, T), Ve($e(n.element), T), Ut(), rn({
                        canScroll: !0
                    }), Qn.ln(gt, n), oi(n.callback) && n.callback();
                }
                function ce(n, t) {
                    nn("fitToSection", n, t);
                }
                function se() {
                    en.canScroll && $().fitToSection && (rn({
                        P: !0
                    }), ae(en.j), rn({
                        P: !1
                    }));
                ...
                function fe() {
                    var n = $().responsive || $().responsiveWidth, t = $().responsiveHeight, e = n && a.innerWidth < n, i = t && a.innerHeight < t;
                    n && t ? de(e || i) : n ? de(e) : t && de(i);
                }
                function de(n) {
                    var t = ve();
                    n ? t || (Gt(!1, "internal"), ce(!1, "internal"), He(Oe(k)), Fe(zn, m), oi($().afterResponsive) && $().afterResponsive.call(K(), n), ln("responsiveSlides", "toSections"), ai(K(), "afterResponsive", n)) : t && (Gt(q().autoScrolling, "internal"), ce(q().autoScrolling, "internal"), Ce(Oe(k)), Ve(zn, m), oi($().afterResponsive) && $().afterResponsive.call(K(), n), ln("responsiveSlides", "toSlides"), ai(K(), "afterResponsive", n));
                }
                function ve() {
                    return Ee(zn, m);
                }
                function pe(n) {
                    $().verticalCentered && (!$().scrollOverflow && Me.mn(n.item) || Me.wn(n) || Ee(n.item, I) || Fe(n.item, I));
                }
                d.moveTo = moveTo, d.getScrollY = function() {
                    return en.scrollY;
                }, Qn.un(rt, function() {
                    clearTimeout(ee), clearTimeout(ie);
                }), d.setFitToSection = ce, d.fitToSection = se, d.setResponsive = de;
                var he, ge = null;
                function me(n) {
                    var t = n.item, e = n.vn.length, i = n.index();
                    !on().j && n.isVisible && (Fe(t, y), It()), !ge && n.isVisible && (ge = on().j.item), un("offsetSections") && De(t, {
                        height: fn(t)
                    }), $().paddingTop && De(t, {
                        "padding-top": $().paddingTop
                    }), $().paddingBottom && De(t, {
                        "padding-bottom": $().paddingBottom
                    }), void 0 !== $().sectionsColor[i] && De(t, {
                        "background-color": $().sectionsColor[i]
                    }), void 0 !== $().anchors[i] && t.setAttribute("data-anchor", n.anchor), e || pe(n);
                }
                function we() {
                    $().scrollOverflow && !$().scrollBar && (Me.bn(), Me.Sn());
                }
                function be() {
                    Qn.removeListener(Kn, we), ii("keyup", Me.yn);
                }
                d.getActiveSection = function() {
                    return on().j;
                }, Qn.un(it, function() {
                    Qn.un(Kn, we), Qn.un(ht, Me.onLeave), Qn.un(pt, Me.onLeave), Qn.un(mt, Me.afterLoad), Qn.un(gt, Me.afterLoad), Qn.un(rt, be), ti("keyup", Me.yn);
                });
                var Se, ye, Me = {
                    Mn: null,
                    Tn: !0,
                    ...
                    kn: function(n) {
                        var t = on().j;
                        if (!en.canScroll || v() && $().scrollOverflow && Me.wn(t) && Me.isScrolled(on().B, t.item)) return qe(n), !1;
                    },
                    En: function(n) {
                        if (!Si() && $().keyboardScrolling && [
                            38,
                            33,
                            32,
                            40,
                            ...
                            36,
                            35
                        ].indexOf(n.keyCode) > -1 && !Me.An) return qe(n), !1;
                    },
                    yn: function() {
                        Me.Tn = en.canScroll;
                    },
                    onLeave: function() {
                        clearTimeout(he), Me.An = !1;
                    },
                    afterLoad: function() {
                        Me.An = !1, clearTimeout(he), he = setTimeout(function() {
                            Me.Tn = en.canScroll;
                        }, 200);
                    },
                    Rn: function() {
                        u.activeElement === this.Mn && (this.Mn.blur(), Me.An = !1);
                    },
                    Sn: function() {
                        if ($().scrollOverflow && Me.Tn) {
                            Me.Rn();
                            var n = Me.jn(on().j.item);
                            !n || l || s || (this.Mn = n, requestAnimationFrame(function() {
                                n.focus({
                                    Dn: !0
                                }), Me.An = !0;
                            })), Me.Tn = !1;
                    ...
                    bn: function() {
                        $().scrollOverflowMacStyle && !c && Fe(zn, "fp-scroll-mac"), on().rn.forEach(function(n) {
                            if (!(n.slides && n.slides.length || Ee(n.item, "fp-auto-height-responsive") && ve())) {
                                var t, e = yn(n.item), i = Me.mn(n.item), o = (t = n).nn ? t : t.parent;
                                if (f) {
                                    var a = i ? "addClass" : "removeClass";
                                    r[a](o.item, C), r[a](n.item, C);
                                } else Fe(o.item, C), Fe(n.item, C);
                                n.q || (Me.Ln(e), Me.zn(e)), n.q = !0;
                            }
                        });
                    },
                    zn: function(n) {
                        Me.jn(n).addEventListener("scroll", Me.Nn), n.addEventListener("wheel", Me.kn, {
                            passive: !1
                        }), n.addEventListener("keydown", Me.En, {
                            passive: !1
                        });
                    },
                    Ln: function(n) {
                        var t = document.createElement("div");
                        t.className = P, Ge(n, t), t.setAttribute("tabindex", "-1");
                    },
                    In: function(n) {
                        var t = Oe(H, n)[0];
                        t && (Xe(t), n.removeAttribute("tabindex"));
                    },
                    jn: function(n) {
                        var t = yn(n);
                        return Oe(H, t)[0] || t;
                    ...
                    q: function(n) {
                        return Ee(n, P) || null != Oe(H, n)[0];
                    },
                    wn: function(n) {
                        return n.nn && n.activeSlide ? n.activeSlide.q : n.q;
                    },
                    mn: function(n) {
                        return Me.jn(n).scrollHeight > a.innerHeight;
                    },
                    isScrolled: function(n, t) {
                        if (!en.canScroll) return !1;
                        if ($().scrollBar) return !0;
                        var e = Me.jn(t);
                        if (!$().scrollOverflow || !Ee(e, P) || Ee(t, "fp-noscroll") || Ee(yn(t), "fp-noscroll")) return !0;
                        var i = f ? 1 : 0, r = e.scrollTop, o = "up" === n && r <= 0, a = "down" === n && e.scrollHeight <= Math.ceil(e.offsetHeight + r) + i, u = o || a;
                        return u || "none" === n || (this.xn = (new Date).getTime()), u;
                    },
                    Pn: function() {
                        this.On = (new Date).getTime();
                        var n = this.On - Me.xn, t = (l || s) && en.Z, e = en.Y && n > 600;
                        return t && n > 400 || e;
                    },
                    Nn: (Se = 0, function(n) {
                        var t = n.target.scrollTop, e = "none" !== en.V ? en.V : Se < t ? "down" : "up";
                        Se = t, oi($().onScrollOverflow) && Zt("onScrollOverflow", {
                            position: t,
                            direction: e
                        }), Ee(n.target, P) && en.canScroll && Me.isScrolled(e, n.target) && Me.Pn() && Me.mn(on().j.item) && Qn.ln(at, {
                            direction: e
                        });
                    })
                };
                function Te(n, t) {
                    a.console && a.console[n] && a.console[n]("fullPage: " + t);
                }
                function Ae(n) {
                    return "none" !== a.getComputedStyle(n).display;
                }
                function xe(n) {
                ...
                function ke(n) {
                    ...
                    for(var t = 1, e = arguments.length; t < e; ++t){
                        var i = arguments[t];
                        if (i) for(var r in i)i.hasOwnProperty(r) && "__proto__" != r && "constructor" != r && ("[object Object]" !== Object.prototype.toString.call(i[r]) ? n[r] = i[r] : n[r] = ke(n[r], i[r]));
                    }
                    return n;
                }
                function Ee(n, t) {
                ...
                function Re() {
                    return "innerHeight" in a ? a.innerHeight : u.documentElement.offsetHeight;
                }
                function je() {
                    return a.innerWidth;
                }
                function De(n, t) {
                    var e;
                    for(e in n = Pe(n), t)if (t.hasOwnProperty(e) && null !== e) for(var i = 0; i < n.length; i++)n[i].style[e] = t[e];
                    return n;
                }
                function Le(n, t) {
                    if (!n) return null;
                ...
                function Ie(n, t) {
                    n = We(n) ? n[0] : n;
                    for(var e = null != t ? Oe(t, n.parentNode) : n.parentNode.childNodes, i = 0, r = 0; r < e.length; r++){
                        if (e[r] == n) return i;
                        1 == e[r].nodeType && i++;
                    }
                    return -1;
                ...
                function Ge(n, t) {
                    for("string" == typeof t && (t = ci(t)), n.appendChild(t); n.firstChild !== t;)t.appendChild(n.firstChild);
                }
                function Xe(n) {
                    for(var t = u.createDocumentFragment(); n.firstChild;)t.appendChild(n.firstChild);
                    n.parentNode.replaceChild(t, n);
                }
                function Ue(n, t) {
                    return n && 1 === n.nodeType ? ui(n, t) ? n : Ue(n.parentNode, t) : null;
                }
                function _e(n, t) {
                ...
                function ti(n, t, e) {
                    u.addEventListener(n, t, "undefined" === e ? null : e);
                }
                function ei(n, t, e) {
                    a.addEventListener(n, t, "undefined" === e ? null : e);
                }
                function ii(n, t, e) {
                    u.removeEventListener(n, t, "undefined" === e ? null : e);
                }
                function ri(n, t, e) {
                ...
                function ai(n, t, e) {
                    var i;
                    e = void 0 === e ? {} : e, "function" == typeof a.CustomEvent ? i = new CustomEvent(t, {
                        detail: e
                    }) : (i = u.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, e), n.dispatchEvent(i);
                }
                function ui(n, t) {
                ...
                function di(n, t, e) {
                    for(var i = n[e], r = []; i;)(ui(i, t) || null == t) && r.push(i), i = i[e];
                    return r;
                }
                function vi(n, t) {
                ...
                function wi(n, t) {
                    n.setAttribute(t, ni(n, "data-" + t)), n.removeAttribute("data-" + t);
                }
                function bi(n, t) {
                    var e = [
                        n
                ...
                function Si() {
                    ...
                    return ui(n, "textarea") || ui(n, "input") || ui(n, "select") || "true" == ni(n, "contentEditable") || "" == ni(n, "contentEditable");
                }
                function yi(n) {
                    Qn.ln($n, {
                        e: n,
                ...
                function Ai() {
                    Fe(Oe($().sectionSelector, K()), A), Fe(Oe($().slideSelector, K()), E);
                }
                function xi(n) {
                    var t = n.slides.length, e = n.vn, i = n.slides, r = 100 * t, o = 100 / t;
                    if (!Oe(L, n.item)[0]) {
                        var a = u.createElement("div");
                        a.className = D, Ye(e, a);
                        var l = u.createElement("div");
                        l.className = z, Ye(e, l);
                    }
                    De(Oe(N, n.item), {
                        width: r + "%"
                    }), t > 1 && ($().controlArrows && function(n) {
                        var t = n.item, e = [
                            ci($().controlArrowsHTML[0]),
                            ci($().controlArrowsHTML[1])
                        ];
                        _e(Oe(L, t)[0], e), Fe(e, V), Fe(e[0], Z), Fe(e[1], "fp-next"), "#fff" !== $().controlArrowColor && (De(Oe(G, t), {
                            "border-color": "transparent transparent transparent " + $().controlArrowColor
                        }), De(Oe(Y, t), {
                            "border-color": "transparent " + $().controlArrowColor + " transparent transparent"
                        })), $().loopHorizontal || He(Oe(Y, t));
                    }(n), $().slidesNavigation && function(n) {
                        var t = n.item, e = n.slides.length;
                        Be(ci('<div class="fp-slidesNav"><ul></ul></div>'), t);
                        var i = Oe(W, t)[0];
                        Fe(i, "fp-" + $().slidesNavPosition);
                        for(var r = 0; r < e; r++)Be(ci('<li><a href="#"><span class="fp-sr-only">' + Jn(r, "Slide", Oe(R, t)[r]) + "</span><span></span></a></li>"), Oe("ul", i)[0]);
                        De(i, {
                        ...
                        De(n.item, {
                            width: o + "%"
                        }), $().verticalCentered && pe(n);
                    });
                    var c = un("responsiveSlides") ? null : n.activeSlide || null;
                    null != c && en.j && (0 !== en.j.index() || 0 === en.j.index() && 0 !== c.index()) ? (Lt(c.item, "internal"), Fe(c.item, "fp-initial")) : Fe(e[0], y);
                }
                window.fp_utils = Object.assign(a.fp_utils || {}, {
                    $: Oe,
                    deepExtend: ke,
                    hasClass: Ee,
                    getWindowHeight: Re,
                ...
                function Ei(n) {
                    var t = ki();
                    (ki() || ln("responsiveSlides", "isResponsiveSlidesChanging") || xe(Oe($().sectionSelector, K())).length !== on().A) && !en._ && ($().observer && ye && ye.disconnect(), Pt(), It(), $().anchors = [], si(Oe(k)), ln("responsiveSlides", "isResponsiveSlidesChanging") || Ai(), tn(), $().navigation && Qt(), t && (si(Oe(W)), si(Oe(B))), on().R.forEach(function(n) {
                        n.slides.length ? t && xi(n) : me(n);
                    })), $().observer && ye && Oe(h)[0] && ye.observe(Oe(h)[0], Oi);
                }
                Qn.un(it, function() {
                    var n, t, e;
                    $().observer && "MutationObserver" in window && Oe(h)[0] && (n = Oe(h)[0], t = Oi, (e = new MutationObserver(Ei)).observe(n, t), ye = e), Qn.un(ot, Ei);
                }), d.render = Ei;
                var Ri = function() {
                    var n = !1;
                    try {
                        ...
                        ei("testPassive", null, t), ri("testPassive", null, t);
                    } catch (n) {}
                    return function() {
                        return n;
                    };
                ...
                var Di, Li, zi, Ni, Ii = (zi = (new Date).getTime(), Ni = [], {
                    Cn: function(n) {
                        var t = (n = n || a.event).wheelDelta || -n.deltaY || -n.detail, e = Math.max(-1, Math.min(1, t)), i = void 0 !== n.wheelDeltaX || void 0 !== n.deltaX;
                        Di = Math.abs(n.wheelDeltaX) < Math.abs(n.wheelDelta) || Math.abs(n.deltaX) < Math.abs(n.deltaY) || !i;
                        var r = (new Date).getTime();
                        Li = e < 0 ? "down" : "up", Ni.length > 149 && Ni.shift(), Ni.push(Math.abs(t));
                        var o = r - zi;
                        zi = r, o > 200 && (Ni = []);
                    },
                    Wn: function() {
                        var n = mi(Ni, 10) >= mi(Ni, 70);
                        return !!Ni.length && n && Di;
                    },
                    Fn: function() {
                        return Li;
                    }
                ...
                function Pi() {
                    var n = $().css3 ? Ke() + Re() : gi(on().R).item.offsetTop + gi(on().R).item.offsetHeight, t = Tn(n);
                    d.test.top = -n + "px", rn({
                        canScroll: !1
                ...
                function Hi() {
                    K().getBoundingClientRect().bottom >= 0 && Ci();
                }
                function Ci() {
                ...
                var Wi, Fi, Vi, Bi = (Wi = !1, Fi = {}, Vi = {}, function(n, t, e) {
                    switch(n){
                        case "set":
                            Fi[t] = (new Date).getTime(), Vi[t] = e;
                            break;
                        case "isNewKeyframe":
                ...
                function Zi() {
                    var n = on().j.next();
                    n || !$().loopBottom && !$().continuousVertical || (n = on().R[0]), null != n ? ae(n, null, !1) : K().scrollHeight < zn.scrollHeight && $().scrollBar && $().scrollBeyondFullpage && Qn.ln(dt);
                }
                function Yi() {
                    var n = on().j.prev();
                    n || !$().loopTop && !$().continuousVertical || (n = gi(on().R)), null != n && ae(n, null, !0);
                }
                d.moveSectionDown = Zi, d.moveSectionUp = Yi;
                var Gi = 0;
                function Xi(n) {
                    $().autoScrolling && (en.canScroll && (n.pageY < Gi && Tt().m.up ? Yi() : n.pageY > Gi && Tt().m.down && Zi()), Gi = n.pageY);
                }
                function Ui(n) {
                    if (Tt().m[n]) {
                        var t = "down" === n ? Zi : Yi;
                        un("scrollHorizontally") && (t = ln("scrollHorizontally", "getScrollSection", {
                            type: n,
                            scrollSection: t
                        })), $().scrollOverflow && Me.wn(on().j) ? Me.isScrolled(n, on().j.item) && Me.Pn() && t() : t();
                    }
                }
                var _i, Qi, Ji, Ki = 0, $i = 0, qi = 0, nr = 0, tr = lr(), er = {
                    Bn: "ontouchmove" in window ? "touchmove" : tr ? tr.move : null,
                    Zn: "ontouchstart" in window ? "touchstart" : tr ? tr.down : null
                };
                function ir(n) {
                    var t = Ue(n.target, x) || on().j.item, e = Me.wn(on().j);
                    if (rr(n)) {
                        rn({
                            Z: !0,
                            Y: !1
                        }), $().autoScrolling && (e && !en.canScroll || $().scrollBar) && qe(n);
                        var i = ur(n);
                        qi = i.y, nr = i.x;
                        var r = Math.abs(Ki - qi) > a.innerHeight / 100 * $().touchSensitivity, o = Math.abs($i - nr) > je() / 100 * $().touchSensitivity, u = Oe(L, t).length && Math.abs($i - nr) > Math.abs(Ki - qi), l = Ki > qi ? "down" : "up";
                        rn({
                            V: u ? $i > nr ? "right" : "left" : l
                        }), u ? !en.I && o && ($i > nr ? Tt().m.right && Qn.ln(nt, {
                            section: t
                        }) : Tt().m.left && Qn.ln(qn, {
                            section: t
                        })) : $().autoScrolling && en.canScroll && r && Ui(l);
                    }
                }
                function rr(n) {
                ...
                function ur(n) {
                    var t = {};
                    return t.y = void 0 !== n.pageY && (n.pageY || n.pageX) ? n.pageY : n.touches[0].pageY, t.x = void 0 !== n.pageX && (n.pageY || n.pageX) ? n.pageX : n.touches[0].pageX, s && rr(n) && $().scrollBar && void 0 !== n.touches && (t.y = n.touches[0].pageY, t.x = n.touches[0].pageX), t;
                }
                function lr() {
                    var n;
                    return a.PointerEvent && (n = {
                        down: "pointerdown",
                        move: "pointermove"
                    }), n;
                }
                function cr(n) {
                    $().autoScrolling && rr(n) && Tt().m.up && (en.canScroll || qe(n));
                }
                function sr(n, t) {
                    var e = null == t ? on().j.item : t, i = mn(en.R, e), r = Oe(L, e)[0];
                    if (!(null == r || cn() || en.I || i.slides.length < 2)) {
                        var o = i.activeSlide, a = "left" === n ? o.prev() : o.next();
                        if (!a) {
                            if (!$().loopHorizontal) return;
                            a = "left" === n ? gi(i.slides) : i.slides[0];
                        }
                        rn({
                            I: !d.test.gn
                        }), kt(r, a.item, n);
                ...
                function hr(n, t) {
                    ...
                    if (null != e) {
                        ...
                        e.anchor && e.anchor === en.C || Ee(e.item, y) ? pr(i) : ae(e, function() {
                            pr(i);
                        });
                    }
                }
                function gr(n, t) {
                    var e = vr(n);
                    void 0 !== t ? hr(n, t) : null != e && ae(e);
                }
                function mr() {
                    clearTimeout(Qi), ii("keydown", wr), ii("keyup", br);
                }
                function wr(n) {
                    clearTimeout(Qi);
                    var t = n.keyCode, e = [
                        37,
                        39
                    ].indexOf(t) > -1, i = $().autoScrolling || $().fitToSection || e;
                    9 === t ? function(n) {
                        var t = n.shiftKey, e = u.activeElement, i = Ar(yn(on().j.item));
                        function r(n) {
                            return qe(n), i[0] ? i[0].focus() : null;
                        }
                        if (en.canScroll) {
                            if (!function(n) {
                                var t = Ar(u), e = t.indexOf(u.activeElement), i = t[n.shiftKey ? e - 1 : e + 1], r = Ue(i, R), o = Ue(i, x);
                                return !r && !o;
                            }(n)) {
                                e ? null == Ue(e, ".fp-section.active,.fp-section.active .fp-slide.active") && (e = r(n)) : r(n);
                                var o = e == i[0], a = e == i[i.length - 1], l = t && o;
                                if (l || !t && a) {
                                    qe(n);
                                    var c = function(n) {
                                        var t, e = n ? "prevPanel" : "nextPanel", i = [], r = Mn((en.j && en.j.activeSlide ? en.j.activeSlide : en.j)[e]());
                                        do {
                                            (i = Ar(r.item)).length && (t = {
                                                Yn: r,
                                                Gn: i[n ? i.length - 1 : 0]
                                            }), r = Mn(r[e]());
                                        }while (r && 0 === i.length)
                    ...
                    }(n) : !Si() && $().keyboardScrolling && i && (_i = n.ctrlKey, Qi = setTimeout(function() {
                        !function(n) {
                            var t = n.shiftKey, e = u.activeElement, i = ui(e, "video") || ui(e, "audio"), r = Me.isScrolled("up", on().j.item), o = Me.isScrolled("down", on().j.item), a = [
                                37,
                                39
                            ].indexOf(n.keyCode) > -1;
                            if (function(n) {
                                (function(n) {
                                    return [
                                        ...
                                        33,
                                        34
                                    ].indexOf(n.keyCode) > -1 && !en.L;
                                })(n) && !Ue(n.target, H) && n.preventDefault();
                            }(n), en.canScroll || a) switch(rn({
                                D: "keydown"
                            }), n.keyCode){
                                case 38:
                                case 33:
                                    Tt().k.up && r ? en.L ? Qn.ln(lt, {
                                        e: n
                                    }) : Yi() : Me.Sn();
                                    break;
                                case 32:
                ...
                function Ar(n) {
                    return [].slice.call(Oe('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], summary:not([disabled]), [contenteditable]', n)).filter(function(n) {
                        return "-1" !== ni(n, "tabindex") && null !== n.offsetParent;
                    });
                }
                d.moveSlideLeft = fr, d.moveSlideRight = dr, d.moveTo = gr, Qn.un(it, function() {
                    ei("blur", Sr), ti("keydown", wr), ti("keyup", br), Qn.un(rt, mr), Qn.un(mt, yr), Qn.un(gt, Mr);
                });
                var xr = (new Date).getTime(), Or = [];
                function kr(n) {
                    n ? (function() {
                        var n, t = "";
                        a.addEventListener ? n = "addEventListener" : (n = "attachEvent", t = "on");
                        var e = "onwheel" in u.createElement("div") ? "wheel" : void 0 !== u.onmousewheel ? "mousewheel" : "DOMMouseScroll", i = ji();
                        "DOMMouseScroll" == e ? u[n](t + "MozMousePixelScroll", Er, i) : u[n](t + e, Er, i);
                    }(), K().addEventListener("mousedown", Rr), K().addEventListener("mouseup", jr)) : (u.addEventListener ? (ii("mousewheel", Er, !1), ii("wheel", Er, !1), ii("MozMousePixelScroll", Er, !1)) : u.detachEvent("onmousewheel", Er), K().removeEventListener("mousedown", Rr), K().removeEventListener("mouseup", jr));
                }
                function Er(n) {
                    var t = (new Date).getTime(), e = Ee(Oe(".fp-completely")[0], "fp-normal-scroll"), i = function(n, t) {
                        (new Date).getTime();
                        var e = on().L && n.getBoundingClientRect().bottom >= 0 && "up" === Ii.Fn(), i = on().Vn;
                        if (i) return qe(t), !1;
                        if (on().L) {
                            if (e) {
                                var r;
                                if (!(i || Bi("isNewKeyframe", "beyondFullpage") && Ii.Wn())) return (r = Tn(gi(on().R).item.offsetTop + gi(on().R).item.offsetHeight)).element.scrollTo(0, r.options), rn({
                                    Vn: !1
                                }), qe(t), !1;
                                if (Ii.Wn()) return e = !1, rn({
                                    Vn: !0
                                }), rn({
                                    D: "wheel"
                                }), Ci(), qe(t), !1;
                            } else Bi("set", "beyondFullpage", 1e3);
                            if (!i && !e) return !0;
                        }
                    }(K(), n);
                    if (en.Y || rn({
                        ...
                        Y: !0,
                        V: "none"
                    }), !Tt().m.down && !Tt().m.up) return !1;
                    if (i) return !0;
                    if (!1 === i) return qe(n), !1;
                    if ($().autoScrolling && !_i && !e) {
                        var r = (n = n || a.event).wheelDelta || -n.deltaY || -n.detail, o = Math.max(-1, Math.min(1, r)), u = void 0 !== n.wheelDeltaX || void 0 !== n.deltaX, l = Math.abs(n.wheelDeltaX) < Math.abs(n.wheelDelta) || Math.abs(n.deltaX) < Math.abs(n.deltaY) || !u, c = o < 0 ? "down" : o > 0 ? "up" : "none";
                        Or.length > 149 && Or.shift(), Or.push(Math.abs(r)), $().scrollBar && qe(n);
                        var s = t - xr;
                        return xr = t, s > 200 && (Or = []), rn({
                            B: c
                        }), en.canScroll && !cn() && mi(Or, 10) >= mi(Or, 70) && l && (rn({
                            D: "wheel"
                        }), Ui(o < 0 ? "down" : "up")), !1;
                    }
                    $().fitToSection && rn({
                ...
                function Rr(n) {
                    var t;
                    2 == n.which && (t = n.pageY, Gi = t, K().addEventListener("mousemove", Xi));
                }
                function jr(n) {
                    2 == n.which && K().removeEventListener("mousemove", Xi);
                }
                function Dr(n) {
                    n ? (kr(!0), function() {
                        if (er.Bn && (l || s) && (!un("dragAndMove") || "mouseonly" === $().dragAndMove)) {
                            $().autoScrolling && (zn.removeEventListener(er.Bn, cr, {
                                passive: !1
                            }), zn.addEventListener(er.Bn, cr, {
                                passive: !1
                            }));
                            var n = $().touchWrapper;
                            n.removeEventListener(er.Zn, or), n.removeEventListener(er.Bn, ir, {
                                passive: !1
                            }), n.addEventListener(er.Zn, or), n.addEventListener(er.Bn, ir, {
                                passive: !1
                            });
                        }
                    }()) : (kr(!1), function() {
                        if (er.Bn && (l || s)) {
                            $().autoScrolling && (zn.removeEventListener(er.Bn, ir, {
                                passive: !1
                            }), zn.removeEventListener(er.Bn, cr, {
                                passive: !1
                            }));
                            var n = $().touchWrapper;
                            n.removeEventListener(er.Zn, or), n.removeEventListener(er.Bn, ir, {
                ...
                function Nr(n, t) {
                    document["fp_" + n] = t, ti(n, Ir, !0);
                }
                function Ir(n) {
                    var t = n.type, e = !1, i = "mouseleave" === t ? n.toElement || n.relatedTarget : n.target;
                    i != document && i ? ("touchend" === t && (Lr = !1, setTimeout(function() {
                        Lr = !0;
                    }, 800)), ("mouseenter" !== t || Lr) && ($().normalScrollElements.split(",").forEach(function(n) {
                        if (!e) {
                            var t = ui(i, n), r = Ue(i, n);
                            (t || r) && (d.shared.Un || Dr(!1), d.shared.Un = !0, e = !0);
                        }
                    }), !e && d.shared.Un && (Dr(!0), d.shared.Un = !1))) : Dr(!0);
                }
                function Pr(n, t) {
                    Dn(0, "internal"), gr(n, t), Dn(q().scrollingSpeed, "internal");
                }
                Qn.un(it, function() {
                ...
                var Hr, Cr, Wr = Re(), Fr = je(), Vr = !1;
                function Br() {
                    clearTimeout(Hr), clearTimeout(Cr), ri("resize", Zr);
                }
                function Zr() {
                    Vr || ($().autoScrolling && !$().scrollBar || !$().fitToSection) && Gr(Re()), en.K && function() {
                        if (l) for(var n = 0; n < 4; n++)Cr = setTimeout(function() {
                            window.requestAnimationFrame(function() {
                                $().autoScrolling && !$().scrollBar && (rn({
                                    P: !0
                                }), Pr(en.j.index() + 1), rn({
                                    P: !1
                                }));
                    ...
                    }(), Vr = !0, clearTimeout(Hr), Hr = setTimeout(function() {
                        !function() {
                            if (rn({
                                P: !0
                            }), (!l || $().adjustOnNavChange) && (Gr(""), ai(K(), "onResize"), $().autoScrolling || en.L || Xr()), Qn.ln(ot), It(), fe(), l) {
                                var n = u.activeElement;
                                if (!ui(n, "textarea") && !ui(n, "input") && !ui(n, "select")) {
                                    var t = Re();
                                    Math.abs(t - Wr) > 20 * Math.max(Wr, t) / 100 && (Yr(!0), Wr = t);
                                }
                            } else e = Re(), i = je(), en.U === e && Fr === i || (rn({
                                U: e
                            }), Fr = i, Yr(!0));
                            var e, i;
                            ai(K(), "onResizeEnds"), rn({
                                P: !1
                            });
                        }(), Vr = !1;
                    }, 400);
                ...
                function Yr(n) {
                    if (!Ee(K(), b)) {
                        ...
                        for(var t = on().R, e = 0; e < t.length; ++e){
                            var i = t[e], r = Oe(L, i.item)[0], o = i.slides;
                            un("offsetSections") && De(i.item, {
                                height: fn(i.item)
                            }), o.length > 1 && kt(r, i.activeSlide.item);
                        }
                        $().scrollOverflow && Me.bn();
                        var u = on().j.index();
                        en.L || !u || un("fadingEffect") || un("dropEffect") || un("waterEffect") || Pr(u + 1), rn({
                            P: !1
                        }), oi($().afterResize) && n && $().afterResize.call(K(), a.innerWidth, a.innerHeight), oi($().afterReBuild) && !n && $().afterReBuild.call(K()), ai(K(), "afterRebuild");
                    }
                }
                function Gr(n) {
                ...
                function Qr() {
                    if (!en.H && !$().lockAnchors) {
                        var n = Ur(), t = n.section, e = n.pn, i = void 0 === en.C, r = void 0 === en.C && void 0 === e && !en.I;
                        t && t.length && (t && t !== en.C && !i || r && !cn() || !en.I && en.W != e && !cn()) && Qn.ln(ut, {
                            Xn: t,
                            slideAnchor: e
                        });
                    }
                ...
                function Jr(n) {
                    var t = n.target;
                    Ue(t, $().menu + " [data-menuanchor]") && Kr.call(t, n.e);
                }
                function Kr(n) {
                    if (rn({
                        D: "menu"
                    }), Oe($().menu)[0] && ($().lockAnchors || !$().anchors.length)) {
                        qe(n);
                        var t = Ue(this, "[data-menuanchor]");
                        Qn.ln(ct, {
                            anchor: ni(t, "data-menuanchor")
                        });
                    }
                }
                function $r(n) {
                    var t = n.target;
                    t && Ue(t, "#fp-nav a") ? Jt.call(t, n.e) : ui(t, ".fp-tooltip") ? _t.call(t) : (ui(t, F) || null != Ue(t, F)) && wt.call(t, n.e);
                }
                d.reBuild = Yr, Qn.un(it, function() {
                    Zr(), Xr(), ei("resize", Zr), Qn.un(rt, Br);
                }), d.setLockAnchors = function(n) {
                    $().lockAnchors = n;
                }, Qn.un(it, function() {
                    ei("hashchange", Qr), Qn.un(rt, _r);
                }), Qn.un(it, function() {
                    ti("wheel", Ii.Cn, ji()), Qn.un(dt, Pi), Qn.un(lt, Hi);
                }), Qn.un(it, function() {
                    Qn.un($n, Jr);
                }), Qn.un(it, function() {
                    Qn.un($n, $r);
                ...
                function eo(n) {
                    var t, e, i, r, o;
                    if (ai(K(), "onScroll"), !en.P && on().j && (gi(on().R), !on().L && !on().Vn && (!$().autoScrolling || $().scrollBar || un("dragAndMove")) && !sn())) {
                        var a = un("dragAndMove") ? Math.abs(ln("dragAndMove", "getCurrentScroll")) : Ke(), u = function(n) {
                            var t = n > to ? "down" : "up";
                            return to = n, rn({
                                X: n
                            }), t;
                        }(a), c = 0, s = a + Re() / 2, f = (un("dragAndMove") ? ln("dragAndMove", "getDocumentHeight") : zn.scrollHeight - Re()) === a, d = on().R;
                        if (rn({
                            scrollY: a
                        }), f) c = d.length - 1;
                        else if (a) for(var v = 0; v < d.length; ++v)(Ue(d[v].item, x) || d[v].item).offsetTop <= s && (c = v);
                        else c = 0;
                        if (i = u, r = on().j.item.offsetTop, o = r + Re(), ("up" == i ? o >= Ke() + Re() : r <= Ke()) && (Ee(on().j.item, T) || (Fe(on().j.item, T), Ve($e(on().j.item), T))), e = (t = d[c]).item, !t.isActive) {
                            rn({
                                H: !0
                            });
                            var p, h, g = on().j.item, m = on().j.index() + 1, w = On(on().j, e), b = t.anchor, S = t.index() + 1, M = t.activeSlide, A = {
                                j: g,
                                sectionIndex: S - 1,
                                anchorLink: b,
                                element: e,
                            ...
                            if (M && (h = M.anchor, p = M.index()), en.canScroll) Ve(d.filter(function(n) {
                                return n.index() !== t.index();
                            }).map(function(n) {
                                return n.item;
                            }), y), Fe(e, y), ln("parallax", "afterLoad"), oi($().beforeLeave) && oe("beforeLeave", A), oi($().onLeave) && Zt("onLeave", A), oi($().afterLoad) && Zt("afterLoad", A), ln("resetSliders", "apply", {
                                localIsResizing: en.P,
                                leavingSection: m
                            }), Fn(g), Bn(t), Cn(e), Kt(b, S - 1), $().anchors.length && rn({
                                C: b
                            }), It(), Xn(p, h, b);
                            clearTimeout(qr), qr = setTimeout(function() {
                                rn({
                                    H: !1
                                });
                            }, 100);
                        }
                        $().fitToSection && en.canScroll && (clearTimeout(no), no = setTimeout(function() {
                            var n;
                            if (!en.R.filter(function(n) {
                                var t = n.item.getBoundingClientRect();
                                return Math.round(t.bottom) === Math.round(Re()) || 0 === Math.round(t.top);
                            }).length) {
                                if (l && (n = document.activeElement) && n.matches("input, textarea")) return;
                                se();
                            }
                        }, $().fitToSectionDelay));
                    }
                ...
                function ro(n) {
                    var t = $().skipIntermediateItems, e = n.items.origin.nn ? "sections" : "slides", i = Math.abs(n.items.origin.index() - n.items.destination.index()) > 1;
                    (!0 === t || t === e) && i && Dn(0, "internal");
                }
                function oo() {
                    $().skipIntermediateItems && nn("scrollingSpeed", q().scrollingSpeed, "internal");
                }
                function ao(n, t) {
                    void 0 !== t ? (t = t.replace(/ /g, "").split(",")).forEach(function(t) {
                        Mt(n, t, "k");
                    }) : (Mt(n, "all", "k"), $().keyboardScrolling = n);
                }
                function uo(n) {
                    var t = n.index();
                    void 0 !== $().anchors[t] && n.isActive && Kt($().anchors[t], t), $().menu && $().css3 && null != Ue(Oe($().menu)[0], h) && Oe($().menu).forEach(function(n) {
                        zn.appendChild(n);
                    });
                }
                function lo() {
                    var n, t, e = on().j, i = on().j.item;
                    Fe(i, T), Bn(on().j), Ut(), Cn(i), t = vr((n = Ur()).section), n.section && t && (void 0 === t || t.index() !== Ie(ge)) || !oi($().afterLoad) || Zt("afterLoad", {
                        j: i,
                        element: i,
                        direction: null,
                        anchorLink: e.anchor,
                    ...
                    }), oi($().afterRender) && Zt("afterRender"), ai(K(), "afterRender");
                }
                function co(n, t) {
                    void 0 !== t ? (t = t.replace(/ /g, "").split(",")).forEach(function(t) {
                        Mt(n, t, "m");
                    }) : Mt(n, "all", "m"), ai(K(), "setAllowScrolling", {
                        value: n,
                        Qn: t
                    });
                }
                function so() {
                    var n = Ur(), t = n.section, e = n.pn;
                    t ? $().animateAnchor ? hr(t, e) : Pr(t, e) : Qn.ln(Kn, null);
                }
                Qn.un(rt, function() {
                    clearTimeout(qr), clearTimeout(no);
                }), Qn.un(it, function() {
                    ei("scroll", eo), u.body.addEventListener("scroll", eo), Qn.un(ut, function(n) {
                        hr(n.Xn, n.slideAnchor);
                    }), Qn.un(ct, function(n) {
                        gr(n.anchor, void 0);
                    }), Qn.un(at, function(n) {
                        ("down" === n.direction ? Zi : Yi)();
                    }), Qn.un(st, function(n) {
                        ae(n.destination);
                    });
                }), Qn.un(rt, function() {
                    ...
                    return Bt(on().j.activeSlide);
                }, d.getScrollX = function() {
                    return en.scrollX;
                }, Qn.un(it, function() {
                    Qn.un(rt, jt), Qn.un(ft, function(n) {
                    ...
                    Qn.un(tt, function() {
                        var t, u, l;
                        rn({
                            Jn: ($().licenseKey, t = $().licenseKey, u = function(t) {
                            ...
                            }(t), (u || l) && (u && e <= u.Kn && u.qn === t.split(n[0])[4] || l || u.$n) || !1)
                        });
                    });
                    var n = [
                        "-"
                    ], t = "2025-0-27".split("-"), e = new Date(t[0], t[1], t[2]), i = [
                        "se",
                        "licen",
                        "-",
                        "v3",
                ...
                }(), Qn.un(vt, ro), Qn.un(gt, oo), Qn.un(pt, ro), Qn.un(mt, oo), Qn.un(et, function() {
                    ao(!0);
                }), d.setKeyboardScrolling = ao, d.shared.nt = lo, d.setAllowScrolling = co;
                var fo = {};
                function vo() {
                    return fo;
                }
                var po, ho, go, mo, wo = !Ee(zn, vn("OHNsd3AtZnVsbHBhZ2UtanM5T20="));
                function bo(n) {
                    if (ho = u.createElement("div"), po = vn("MTIzPGRpdj48YSBocmVmPSJodHRwOi8vYWx2YXJvdHJpZ28uY29tL2Z1bGxQYWdlL2V4dGVuc2lvbnMvIiBzdHlsZT0iY29sb3I6ICNmZmYgIWltcG9ydGFudDsgdGV4dC1kZWNvcmF0aW9uOm5vbmUgIWltcG9ydGFudDsiPlVubGljZW5zZWQgZnVsbFBhZ2UuanMgRXh0ZW5zaW9uPC9hPjwvZGl2PjEyMw=="), wo || (po = po.replace("extensions/", "").replace("Extension", "")), ho.innerHTML = po, ho = ho.firstChild, "MutationObserver" in window && new MutationObserver(yo).observe(u.body, {
                        childList: !0,
                        subtree: !1
                    }), (!wo || un(n) && d[n]) && (!function(n) {
                        var t = void 0 !== vo()[n] && vo()[n].length, e = [], i = !1;
                        return We(vo()[n]) ? e = vo()[n] : e.push(vo()[n]), e.forEach(function(e) {
                            var r = function() {
                                if (u.domain.length) {
                                    for(var n = u.domain.replace(/^(www\.)/, "").split("."); n.length > 2;)n.shift();
                                ...
                                "NTU1S2V5Nzc3",
                                "NDU2dGVzdDQ1Ng=="
                            ], a = vn(o[0]), l = vn(o[1]), c = vn(o[2]), s = vn(o[6]), f = vn(o[3]), d = vn(o[4]), v = vn(o[5]), p = void 0 !== $()[d + v];
                            t = t || p;
                            var h = [
                                a,
                                l,
                            ...
                            if (!t && !p && h) return !1;
                            var g = t ? vn(e) : "", m = (g = g.split("_")).length > 1 && g[1].indexOf(n, g[1].length - n.length) > -1, w = g.length > 1 && g[1].toLowerCase().indexOf(d) > -1, b = g[0].indexOf(r, g[0].length - r.length) < 0, S = m || w;
                            i = i || !(b && h && f != g[0]) && S || !h;
                        }), i;
                    }(n) || !wo)) {
                        So();
                ...
                function So() {
                    ho && (mo || (Math.random() < .5 ? dn(zn, ho) : Be(ho, zn), mo = !0), ho.setAttribute("style", vn("").replace(/;/g, vn("MTIzICFpbXBvcnRhbnQ7MzQ1"))));
                }
                function yo(n) {
                    n.forEach(function(n) {
                        if (n.removedNodes[0] && n.removedNodes[0].isEqualNode(ho)) {
                            clearTimeout(go);
                ...
                function Ao() {
                    ...
                    "" === $().licenseKey.trim() ? (Te("error", "Fullpage.js requires a `licenseKey` option. Read about it on the following website:"), Te("error", "https://alvarotrigo.com/fullPage/docs/#licensekey")) : $() && en.Jn || u.domain.indexOf("alvarotrigo.com") > -1 ? n && n.length : (Te("error", "Incorrect `licenseKey`. Get one for fullPage.js version 4 here:"), Te("error", "https://alvarotrigo.com/fullPage/pricing")), Ee(Nn, S) ? Te("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : ($().continuousVertical && ($().loopTop || $().loopBottom) && ($().continuousVertical = !1, Te("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), !$().scrollOverflow || !$().scrollBar && $().autoScrolling || Te("warn", "Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox"), !$().continuousVertical || !$().scrollBar && $().autoScrolling || ($().continuousVertical = !1, Te("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), $().anchors.forEach(function(n) {
                        ...
                        if (e.length || t.length) {
                            ...
                            (e.length || t.length) && Te("error", '"' + n + '" is is being used by another element `' + i + "` property");
                        }
                    }));
                }
                function xo() {
                    return {
                        ...
                        internals: {
                            ...
                            lazyLoad: Vn,
                            addAnimation: xn,
                            performHorizontalMove: Et,
                            landscapeScroll: kt,
                            silentLandscapeScroll: Lt,
                            keepSlidesPosition: Xt,
                            silentScroll: jn,
                            styleSlides: xi,
                            styleSection: me,
                            scrollHandler: eo,
                            ...
                            getState: on,
                            updateState: It,
                            updateStructuralState: Pt,
                            activeSlidesNavigation: bt,
                            getPanels: function() {
                                return en.rn;
                            },
                ...
                function Oo(n) {
                    var t = [
                        "NTY3YnVuZGxlNzg5",
                        "NTU1S2V5Nzc3"
                    ], e = vn(t[0]), i = vn(t[1]), r = void 0 !== $()[e + i], o = "fp_" + n + "Extension";
                    vo()[n] = r ? $()[e + i] : $()[n + i], d[n] = void 0 !== window[o] ? new window[o] : null, d[n] && d[n].c(n);
                }
                function ko(n, t) {
                    var e;
                    if (zn = Oe("body")[0], Nn = Oe("html")[0], In = Oe("html, body"), !Ee(Nn, S)) return e = "string" == typeof n ? Oe(n)[0] : n, X.touchWrapper = e, function(n) {
                        J = ke({}, X, n), Q = Object.assign({}, J);
                    }(t), function(n) {
                        U = n;
                    }("string" == typeof n ? Oe(n)[0] : n), Qn.ln(tt), Ao(), d.getFullpageData = xo, d.version = "4.0.33", d.test = Object.assign(d.test, {
                        top: "0px",
                        on: "translate3d(0px, 0px, 0px)",
                        cn: function() {
                            for(var n = [], t = 0; t < Oe($().sectionSelector, K()).length; t++)n.push("translate3d(0px, 0px, 0px)");
                            return n;
                        }(),
                        left: function() {
                            for(var n = [], t = 0; t < Oe($().sectionSelector, K()).length; t++)n.push(0);
                            return n;
                        }(),
                        options: $(),
                        setAutoScrolling: null
                    }), d.shared = Object.assign(d.shared, {
                        nt: null,
                        Un: !1
                    }), a.fullpage_api = d, a.fullpage_extensions = !0, K() && (Qn.ln(et), Oo("continuousHorizontal"), Oo("scrollHorizontally"), Oo("resetSliders"), Oo("interlockedSlides"), Oo("responsiveSlides"), Oo("fadingEffect"), Oo("dragAndMove"), Oo("offsetSections"), Oo("scrollOverflowReset"), Oo("parallax"), Oo("cards"), Oo("dropEffect"), Oo("waterEffect"), ln("dragAndMove", "init"), ln("responsiveSlides", "init"), To(), Qn.ln(it), rn({
                        K: !0
                    }), ln("dragAndMove", "turnOffTouch")), a.fullpage_api;
                    Ao();
                }
                return d.destroy = function(n) {
                    ai(K(), "destroy", n), Gt(!1, "internal"), co(!0), Dr(!1), ao(!1), Fe(K(), b), Qn.ln(rt), ln("dragAndMove", "destroy"), n && (jn(0), Oe("img[data-src], source[data-src], audio[data-src], iframe[data-src]", K()).forEach(function(n) {
                        wi(n, "src");
                    }), Oe("img[data-srcset]").forEach(function(n) {
                        wi(n, "srcset");
                    }), si(Oe("#fp-nav, .fp-slidesNav, .fp-controlArrow")), De(gn(on().R), {
                        height: "",
                        "background-color": "",
                        padding: ""
                    }), De(gn(on().slides), {
                        ...
                        overflow: "",
                        height: ""
                    }), Ve(Nn, S), Ve(zn, m + " " + g), zn.className.split(/\s+/).forEach(function(n) {
                        0 === n.indexOf("fp-viewing") && Ve(zn, n);
                    }), gn(on().rn).forEach(function(n) {
                        $().scrollOverflow && Me.In(n), Ve(n, "fp-table active fp-completely " + C);
                        var t = ni(n, "data-fp-styles");
                        t && n.setAttribute("style", t), Ee(n, A) && !_ && n.removeAttribute("data-anchor");
                    }), kn(K()), [
                        O,
                        N,
                        L
        ...
        /***/ },
        /***/ 565: (module1, __unused_webpack_exports, __webpack_require__)=>{
            "use strict";
            /* istanbul ignore next  */ function setAttributesWithoutAttributes(style) {
                var nonce = ("TURBOPACK compile-time truthy", 1) ? __webpack_require__.nc : ("TURBOPACK unreachable", undefined);
                if (nonce) {
        ...
        /***/ 497: (module1)=>{
            "use strict";
            module1.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
        /***/ }
    };
    /************************************************************************/ /******/ // The module cache
    ...
    (()=>{
        ...
        /* eslint-disable import/no-extraneous-dependencies */ const Wrapper = (_ref)=>{
            let { children } = _ref;
...
"[project]/node_modules/next/dist/client/legacy/image.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
const _jsxruntime = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/react/jsx-runtime.js [app-client] (ecmascript)");
const _react = /*#__PURE__*/ _interop_require_wildcard._(__turbopack_context__.r("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)"));
const _reactdom = /*#__PURE__*/ _interop_require_wildcard._(__turbopack_context__.r("[project]/node_modules/next/dist/compiled/react-dom/index.js [app-client] (ecmascript)"));
...
const DEFAULT_Q = 75;
const configEnv = ("TURBOPACK compile-time value", JSON.parse('{"deviceSizes":[640,750,828,1080,1200,1920,2048,3840],"imageSizes":[16,32,48,64,96,128,256,384],"path":"/_next/image","loader":"default","dangerouslyAllowSVG":false,"unoptimized":false,"domains":[],"remotePatterns":[{"protocol":"https","hostname":"i.scdn.co"}]}'));
...
"[project]/node_modules/next/legacy/image.js [app-client] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
module.exports = __turbopack_context__.r("[project]/node_modules/next/dist/client/legacy/image.js [app-client] (ecmascript)");
}}),
...
//# sourceMappingURL=node_modules_63d2cf9c._.js.map